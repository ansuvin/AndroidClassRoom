...
class ChatRoomActivity: AppCompatActivity() {
    ...
    private var mSocket: Socket = IO.socket("http://3c2ab365db8c.ngrok.io")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val chat_recyclerview : RecyclerView = findViewById(R.id.chat_recyclerview);
    ...
    fun sendMessage() {
        ...
        Log.e("sendmmm", preferences.getString("name", "").toString())
